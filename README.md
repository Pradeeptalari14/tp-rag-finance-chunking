# 💰 RAG Finance Chunking

> Custom text extractor splitting corporate reports and tables into semantic sections with 20% overlap.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-finance-chunking/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-finance-chunking.git
cd tp-rag-finance-chunking
```
...
```bash
kubectl port-forward deployment/tp-rag-finance-chunking 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── finance_chunking.py     # Main configuration file
```
...
---
*Generated by [RAG Finance Chunking Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-finance-chunking/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
